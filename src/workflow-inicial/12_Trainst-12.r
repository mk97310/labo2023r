...
PARAM$final_train <- c(
  202012, 202011, 202010, 202009, 202008, 202002, 202001, 201912,
...
PARAM$train$training <- c(
  ...
  201904, 201903,201902, 201901,201812
)

PARAM$train$validation <- c(202011)
...
PARAM$train$semilla <- 111509 # cambiar por su propia semilla  !!!
